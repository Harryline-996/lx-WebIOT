<template>
  <div class="app-container">
    <div class="filter-container" style="margin-left: 0px; margin-bottom: 20px;">
      <el-input v-model="listQuery.id" clearable placeholder="设备ID" style="width: 150px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.name" clearable placeholder="设备名称" style="width: 150px;" class="filter-item" @keyup.enter.native="handleFilter" />
  ...
  methods: {
    fetchData() {
      ...
      getEquipmentInfo().then(response => {
        const { id, name, info, minVal, maxVal, alert, dateRange, page = 1, limit = 20 } = this.listQuery
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        ...
        const filterVal = ['id', 'name', 'lng', 'lat', 'value', 'alert', 'info', 'timestamp']
